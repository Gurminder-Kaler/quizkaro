...
router.post('/signUp', userController.sendSignUpOtp);

router.post('/googleSignIn', userController.googleSignIn);

router.post('/signUpVerifyOtp', userController.verifySignUpOtp);

router.post('/signUpResendOtp', userController.signUpResendOtp);

router.post('/updateUser', upload.fields(fields), userController.updateUser);

router.post('/login', userController.loginUser);

router.post('/updateAccountSetting', userController.updateAccountSetting);

router.post('/updateTimelineSetting', userController.updateTimelineSetting);
