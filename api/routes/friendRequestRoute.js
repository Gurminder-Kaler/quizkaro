...
router.post(
  '/getAllFriendsViaId',
  friendRequestController.getAllFriendsViaUserId
)

router.post(
  '/getAllPendingFriendRequests',
  friendRequestController.getAllPendingFriendRequests
)

router.post(
  '/updateFriendRequestSetting',
  friendRequestController.updateFriendRequestSetting
)

router.post('/getAllNonFriends', friendRequestController.getAllNonFriends)
