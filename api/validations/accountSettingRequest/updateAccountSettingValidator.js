...
module.exports = function updateAccountSettingValidator(payload) {
  ...
  payload.hideFriendList = !isEmpty(payload.hideFriendList)
    ? payload.hideFriendList
    : false;
  payload.lockChatBox = !isEmpty(payload.lockChatBox)
    ? payload.lockChatBox
    : false;
  ...
  if (
    !Validator.isIn(payload.visibleTo, ["public", "friends_only", "only_me"])
  ) {
    errors.visibleTo =
      "visibleTo can either be public, friends_only or only_me";
  }
